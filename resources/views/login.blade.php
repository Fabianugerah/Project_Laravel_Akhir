...
<body>
    ...
    <section class="py-3 py-md-5 py-xl-8">
        ...
        <div class="container mt-4">
            ...
            <!-- Notifikasi Error -->
            @if(session('error'))
                <div class="alert alert-danger justify-content-center text-center mb-3" role="alert">
                ...
                <div class="col-12 col-lg-10 col-xl-8">
                    <div class="row gy-5 justify-content-center">
                        <div class="col-12 col-lg-5">
                            <form action="{{ route('doLogin') }}" id="loginForm" method="POST">
                                @csrf
                                <div class="row gy-3 overflow-hidden">
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control border-0 border-bottom rounded"
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control border-0 border-bottom rounded"
                                    ...
                                    <div class="col-12">
                                        <div class="row justify-content-between login_up">
                                            <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <input type="submit" class="btn btn-lg btn-dark rounded fs-6"  value="Log In"></input>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-12 col-lg-5 d-flex align-items-center">
                            <div class="d-flex gap-3 flex-column w-100">
                                <a href="#" class="btn bsb-btn-2xl btn-outline-dark rounded d-flex align-items-center">
